...
German/English to match historiographical convention; live acceptance feedback
re-prioritised user legibility (MacBook recordings) over source-language
authenticity, so all three personas now speak Japanese. Original-language key
terms may still appear parenthetically. Missing persona ids skip injection
rather than raising — new personas just default to the model's own language
choice."""
